	...
	if event.code != 0:
		...
		#print(event)
            ...
            if event.code == 17:
                if event.value ==1:
                    print("top button pressed")
                    testStepper2.step(10, "left",1000); #steps, dir, speed, stayOn
            if event.code == 16:
                if event.value ==-1:
                    print("left button pressed")
                    testStepper3.step(10, "left",1000); #steps, dir, speed, stayOn
            if event.code == 16:
                if event.value ==1:
            ...
            if event.code == 307:
                if event.value ==-1:
                    print("left button pressed")
                    testStepper1.step(10, "left",1000); #steps, dir, speed, 
                    testStepper2.step(10, "left",1000); #steps, dir, speed, stayOn
                    testStepper3.step(10, "left",1000); #steps, dir, speed, stayOn
